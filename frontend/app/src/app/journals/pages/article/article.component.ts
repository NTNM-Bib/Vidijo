...
export class ArticleComponent implements OnInit {
    ...
    if (!this.article) {
      this.route.params.subscribe(async params => {
        ...
        this.authService.currentUser.subscribe((user: IUser) => {
          ...
          this.isInReadingList = this.userService.isInReadingList(this.article._id);
        });
  ...
  addArticleToReadingList() {
    this.userService.addArticleToReadingList(this.article._id)
      .then(() => {
        this.alertService.showSnackbarAlert("Added this article to your reading list", "Okay", () => { });
      })
      .catch((err: Error) => {
        this.alertService.showSnackbarAlert("Cannot add this article to your reading list", "Retry", () => {
  ...
  removeArticleFromReadingList() {
    this.userService.removeArticleFromReadingList(this.article._id)
      .then(() => {
        this.alertService.showSnackbarAlert("Removed this article from your reading list", "Okay", () => { });
      })
      .catch((err: Error) => {
        this.alertService.showSnackbarAlert("Cannot remove this article from your reading list", "Retry", () => {
