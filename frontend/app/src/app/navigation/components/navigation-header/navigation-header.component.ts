...
import { Router, RoutesRecognized, NavigationEnd, ActivatedRoute, ActivatedRouteSnapshot, Params } from '@angular/router';
...
export class NavigationHeaderComponent implements OnInit {
  ...
  enterAdminMode() {
    ...
    this.alertService.showSnackbarAlert("You are now in admin mode", "Okay", () => { });
  }
  ...
  private pushNavStack(route: string, title: string, snapshot: ActivatedRouteSnapshot) {
  ...
  private updateNavigation() {
    ...
    this.previousLocationTitle = this.hasPreviousLocation ? this.navStack[this.navStack.length - 1].title : "";
  }
  ...
  @HostListener("window:scroll") onScroll() {
    ...
    this.showFloatingToolbar = !this.isMobile || isScrollingUp || window.scrollY <= 0;
