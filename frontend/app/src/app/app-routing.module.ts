...
const routes: Routes = [
  ...
  { path: "home", component: HomeComponent, data: { animation: "Home", title: "Home - Vidijo" } },
  { path: "journals", component: AllComponent, data: { animation: "Journals", title: "All Journals - Vidijo" } },
  { path: "discover", component: DiscoverComponent, data: { animation: "Discover", title: "Discover - Vidijo" } },
  { path: "categories", component: CategoriesComponent, data: { animation: "Categories", title: "Categories - Vidijo" } },
  { path: "info", component: InfoComponent, data: { title: "Information - Vidijo" } },
  { path: "onboarding", component: OnboardingComponent, data: { title: "First Steps - Vidijo" } },
  { path: "login", component: LoginComponent, data: { title: "Login - Vidijo" } },
  { path: "register", component: RegisterComponent, data: { title: "Create Account - Vidijo" } },
  { path: "readingList", component: ReadingListComponent, data: { title: "Reading List - Vidijo" } },
  { path: "search", component: SearchComponent, data: { title: "Search - Vidijo" } },
  { path: "users", component: AdminComponent, data: { title: "Users - Vidijo" } },
  { path: "add-journals", component: AddJournalComponent, data: { title: "Add Journals - Vidijo" } },
  { path: "edit-journal/:id", component: EditJournalComponent, data: { title: "Edit Journal - Vidijo" } },
  { path: "edit-category/:id", component: EditCategoryComponent, data: { title: "Edit Category - Vidijo" } },
  { path: "edit-user/:id", component: EditUserComponent, data: { title: "Edit User - Vidijo" } },
