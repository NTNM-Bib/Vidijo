...
export class ReadingListComponent implements OnInit {
  ...
  private getReadingListArticles() {
    this.userService.getReadingList(`?populate=publishedIn&populateSelect=cover title`)
      .then((readingList: IArticle[]) => {
        this.readingList = readingList;
      })
      .catch(() => {
        this.readingList = [];
        this.alertService.showSnackbarAlert("Cannot load your reading list", "Retry", () => {
          this.getReadingListArticles();
        }, 5000, true);
      });
  }
