...
export class UserService {
  ...
  public isInReadingList(articleId: string): boolean {
    if (!(this.authService.currentUserValue && this.authService.currentUserValue.readingList)) {
      return false;
    }
  ...
  public isAFavoriteJournal(journalId: string): boolean {
    if (!(this.authService.currentUserValue && this.authService.currentUserValue.favoriteJournals)) {
      return false;
    }

    return this.authService.currentUserValue.favoriteJournals.includes(journalId);
  }
